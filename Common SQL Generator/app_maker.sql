...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE(');');
  --
  DBMS_OUTPUT.PUT_LINE('-- FUNCTION COUNT_FILTER_RECORDS-----------------------------------------');
  DBMS_OUTPUT.PUT_LINE('FUNCTION COUNT_FILTER_RECORDS( --');
  DBMS_OUTPUT.PUT_LINE('P_FILTER_VIEW_NAME VARCHAR2');
  DBMS_OUTPUT.PUT_LINE('--');
  ...
  DBMS_OUTPUT.PUT_LINE('C_DATE CONSTANT VARCHAR2(100) := TO_CHAR(SYSDATE,''RRRR/MM/DD HH24:MI:SS'',''NLS_CALENDAR=PERSIAN'');');
  DBMS_OUTPUT.PUT_LINE('BEGIN');
  DBMS_OUTPUT.PUT_LINE('LV_SQL := ''CREATE OR REPLACE VIEW '' || P_FILTER_VIEW_NAME ||'' AS ''');

  DBMS_OUTPUT.PUT_LINE('|| CHR(10)||''SELECT ''');
  -- <edit fields
  DELIMITTER := '||''';
  FOR C IN TABLE_COLUMNS
  LOOP
  ...
  --where clause>
  DBMS_OUTPUT.PUT_LINE('--');
  DBMS_OUTPUT.PUT_LINE('||CHR(10)||''/*''||C_DATE||''*/'';');
  ...
  DBMS_OUTPUT.PUT_LINE('P_FILTER_VIEW_NAME VARCHAR2');
  DBMS_OUTPUT.PUT_LINE('--');
  DBMS_OUTPUT.PUT_LINE(') RETURN NUMBER IS');
  DBMS_OUTPUT.PUT_LINE('LV_SQL VARCHAR2(200);');
  DBMS_OUTPUT.PUT_LINE('LV_CNT NUMBER;');
  DBMS_OUTPUT.PUT_LINE('BEGIN');
  DBMS_OUTPUT.PUT_LINE('LV_SQL := '' SELECT COUNT(1) FROM '' || P_FILTER_VIEW_NAME;');
  DBMS_OUTPUT.PUT_LINE('BEGIN');
  DBMS_OUTPUT.PUT_LINE('EXECUTE IMMEDIATE LV_SQL');
  DBMS_OUTPUT.PUT_LINE('INTO LV_CNT;');
  DBMS_OUTPUT.PUT_LINE('EXCEPTION');
  DBMS_OUTPUT.PUT_LINE('WHEN OTHERS THEN');
  DBMS_OUTPUT.PUT_LINE('NULL;');
  DBMS_OUTPUT.PUT_LINE('END;');
  DBMS_OUTPUT.PUT_LINE('LV_CNT := NVL(LV_CNT, 0);');
  DBMS_OUTPUT.PUT_LINE('RETURN LV_CNT;');
  DBMS_OUTPUT.PUT_LINE('END;');
